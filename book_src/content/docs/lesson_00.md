...
{{% img "l0_2.jpg" %}}Установка библиотеки через терминал в PyCharm{{% /img %}} 
...
{{% img "l0_3.jpg" %}}Создание нового файла кода в PyCharm{{% /img %}} 
...
{{% img "l0_4.jpg" %}}Скриншот программы WinSCP{{% /img %}} 
...
{{% img "l0_6.jpg" %}}Проверка статуса бота через systemd{{% /img %}} 
